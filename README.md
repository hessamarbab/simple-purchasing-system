### This is a sample code; too many things simplified!
...
# Apis 
## Headers
### **Use these headers for all APIs**
```
...
```
### or return this one if your username and user_id doesn't match :
```json
{
	"message": "Unauthenticated."
}
```
### or you may get a validation error like this :
```json
{
